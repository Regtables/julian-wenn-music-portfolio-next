  ...
  return (
    <section className='flex w-full h-screen'>
      ...
      <div className='flex text-custom-gold flex-col items-end w-1/2 gap-5 lg:px-section-x-desktop lg:pt-8 h-full justify-center'>
        <h2 className='ml-auto w-auto text-8xl text-end uppercase'>{heading}</h2>
        ...
        <form className='w-full flex flex-col gap-2'>
          ...
          <textarea className='w-full border-2 border-custom-gold rounded-lg px-3 py-2' placeholder='your message'/>
