  ...
  return (
    ...
    >
      <div className="relative flex lg:flex-row flex-col justify-between lg:items-end items-start w-full h-full">
        ...
        <div className="flex flex-col lg:justify-between h-full text-[var(--color-gold)] lg:gap-0 md:gap-4">
          {NAV_LINKS.map((link, i) => (
            <div
              key={i}
              // href={link.slug}
              className="lg:text-6xl md:text-6xl uppercase font-heading tracking-[1px] hover:text-custom-white transition-colors duration-500 cursor-pointer"
